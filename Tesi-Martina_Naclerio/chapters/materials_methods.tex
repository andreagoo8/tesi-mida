...
% Subfigure 2
	\subcaptionbox%
		[]%
		{Microscopic view of \species{C.~vulgaris}\label{subfig:v}}%
		{\includegraphics[width=0.5\textwidth]{example-image}}%
\caption%
[]%
{}
...
% Subfigure 2
	\subcaptionbox%
		[]%
		{View of \species{P.~palmata}\label{subfig:}}%
		{\includegraphics[width=0.5\textwidth]{example-image}}%
\caption%
[]%
{}
...
\input{../plots/mpl/barplots_anova/latex_figure_code/latex_figure_code-outs/spirulina-barplot_anova.tex}
...
\input{../plots/mpl/barplots_anova/latex_figure_code/latex_figure_code-outs/chlorella-barplot_anova.tex}
...
\input{../plots/mpl/barplots_anova/latex_figure_code/latex_figure_code-outs/palmaria-barplot_anova.tex}
