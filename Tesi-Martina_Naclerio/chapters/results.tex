...
\hspace*{0.05\textwidth}%
	\begin{minipage}[b]{0.475\textwidth}%
	\centering%
		\includegraphics[width=0.9\textwidth]{../plots/mpl/forms/jot_forms/jot_forms-outs/burger_1}%
...
\hspace*{0.05\textwidth}%
	\begin{minipage}[b]{0.475\textwidth}%
	\centering%
		\includegraphics[width=0.9\textwidth]{../plots/mpl/forms/jot_forms/jot_forms-outs/burger_2}%
...
\hspace*{0.05\textwidth}%
	\begin{minipage}[b]{0.475\textwidth}%
	\centering%
		\includegraphics[width=0.9\textwidth]{../plots/mpl/forms/jot_forms/jot_forms-outs/burger_3}%
